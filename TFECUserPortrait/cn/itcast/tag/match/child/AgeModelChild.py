# @desc : 年龄标签, 解决第1个标签索引不存在的问题, 且使用标准标签流程方案.   方案1: 提交创建好索引和映射.
__coding__ = "utf-8"
...
class AgeModelChild(AbstractBaseModel):
...
# 为了不和之前的索引表冲突, 我们可以去 AbstractBaseModel 类中,
# 修改最终ES索引表的名字为: tfec_userprofile_result_test
