...
-- 有效线索宽表
create table edu_dwb.customer_clue_dwb1(
...
insert into edu_dwb.customer_clue_dwb1 partition(start_date)
SELECT
  cc.id,
  cc.create_date_time,
  cc.update_date_time,
  ...
  cc.end_date,
  cc.start_date
from edu_dwd.fact_customer_relationship ll
left join edu_dwd.fact_customer_clue cc on cc.id = ll.customer_id
